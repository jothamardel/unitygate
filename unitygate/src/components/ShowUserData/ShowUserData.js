      ...
      <div className='container'> 
        ...
        <main className="pa4 black-80 shadow-2 bg-white">
            ...
            <div className='center'>
                <button className="updateprofile f6 link dim ba ph3 pv2 mb2 dib white bg-green pointer" onClick={ () => edit(user[0].id)}>Update Profile</button>
                <button className="updateprofile f6 link dim ba ph3 pv2 mb2 dib white bg-green pointer" >Message { user[0].name }</button>
            </div>
        </main>
        </div>
    </div>
